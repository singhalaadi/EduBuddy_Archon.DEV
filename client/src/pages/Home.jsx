...
const Home = () => {
  const { setUserGrade, setUserSubject, setQuestions, setLoading } =
    useAppContext();
          ...
          <div className="flex-1 space-y-8">
            ...
            <header className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              <div>
                ...
                <p className="text-gray-500 font-reading">
            ...
            >
              <div className="relative z-10 max-w-md">
                <h2 className="text-2xl font-bubble font-bold text-blue-900 mb-2">
                  Today's Mission
                </h2>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              >
                ...
                <h3 className="text-xl font-bubble font-bold text-gray-800 mb-1">
                  Fun Numbers
                </h3>
                <p className="text-gray-400 text-sm mb-6">
                  Master counting and basic math
                </p>
                <button
                  onClick={handleStartLearning}
              ...
              <motion.div
                whileHover={{ y: -5 }}
                className="bg-white p-6 rounded-3xl shadow-sm border border-gray-100 flex flex-col opacity-80 relative group"
                title="Complete Math lessons to unlock English!"
              >
                {/* Tooltip */}
                <div className="absolute -top-12 left-1/2 transform -translate-x-1/2 bg-gray-800 text-white text-xs px-3 py-2 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap pointer-events-none z-10">
                  Complete Math Level 1 to unlock! 🎯
                ...
                <button
                  disabled
                  className="mt-auto w-full bg-gray-100 text-gray-400 py-3 rounded-xl font-bold flex items-center justify-center gap-2 cursor-not-allowed"
                >
            ...
            <div className="grid grid-cols-2 gap-6">
              <button
                onClick={handleStartLearning}
                className="bg-pink-50 hover:bg-pink-100 p-4 rounded-2xl flex items-center gap-4 transition-colors group"
              >
              ...
              <button
                onClick={() =>
                  window.open(
                    "https://www.youtube.com/results?search_query=math+for+kids+grade+1",
                    "_blank"
                  )
                }
                className="bg-red-50 hover:bg-red-100 p-4 rounded-2xl flex items-center gap-4 transition-colors group"
              >
                ...
                <div className="flex flex-col items-start">
                  ...
                  <span className="text-xs text-gray-500">Learn visually</span>
                </div>
              </button>
            </div>
          </div>
          ...
          <aside className="w-full lg:w-80 flex-shrink-0 space-y-6">
            <div className="bg-white rounded-[2rem] p-6 shadow-sm border border-gray-100 h-full">
              <div className="flex items-center justify-between mb-8">
                <h3 className="font-bubble font-bold text-gray-800 text-lg">
                  Your Progress
                </h3>
              ...
              <div className="flex flex-col items-center mb-8">
                <div className="w-48 h-48 relative mb-4">
                  ...
                  >
                    <path
                      d="M100 180 C 60 180, 40 150, 40 150 L 160 150 C 160 150, 140 180, 100 180 Z"
                      fill="#5D4037"
                    />
                    <rect
                      x="85"
                ...
                <p className="text-gray-500 text-sm text-center">
                  Keep learning to grow your tree! 🌿
                </p>
              </div>
              ...
              <div>
                <div className="flex justify-between text-xs font-bold text-gray-400 mb-2">
                  <span>Progress</span>
                  <span>
                    {user.stats?.progress || 0}% to Level{" "}
                    {(user.stats?.level || 1) + 1}
                  </span>
                </div>
