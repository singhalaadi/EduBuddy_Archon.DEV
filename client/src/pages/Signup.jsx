...
import { Mail, Lock, User as UserIcon, BookOpen, UserPlus, Eye, EyeOff } from 'lucide-react';
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await apiClient.post('/auth/register', {
        ...
        learningProfile: { preferredStyle: 'visual' }
      });
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 flex items-center justify-center p-4">
      ...
      >
        ...
        <div className="flex items-center justify-center gap-3 mb-8">
          ...
          <h1 className="text-3xl font-bubble font-bold text-blue-900">EduBuddy</h1>
        </div>

        <h2 className="text-2xl font-bold text-gray-800 mb-2 text-center">Create Account</h2>
        <p className="text-gray-500 text-center mb-8">Start your learning adventure today!</p>
