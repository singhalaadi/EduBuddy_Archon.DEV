...
import { 
  Sparkles, BookOpen, Target, TrendingUp, Award, 
  Globe, Volume2, Download, ChevronRight, Star
} from 'lucide-react';
        ...
        <div className="max-w-4xl mx-auto p-8">
          ...
          >
            ...
            <h1 className="text-4xl font-bubble font-bold text-blue-900 mb-4">
              {language === 'english' ? 'Hi! I\'m your AI Learning Buddy! 🎓' : 'नमस्ते! मैं आपका AI सीखने का साथी हूँ! 🎓'}
            </h1>
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-8">
            ...
            >
              <h3 className="text-2xl font-bubble font-bold text-blue-900 mb-4">
                {language === 'english' ? 'Choose Your Grade' : 'अपनी कक्षा चुनें'}
              </h3>
            ...
            >
              ...
              <div className="space-y-3">
                {[
                  { value: 'Math', label: 'Mathematics', labelHindi: 'गणित', icon: '🔢' },
                  { value: 'English', label: 'English', labelHindi: 'अंग्रेज़ी', icon: '📚' },
                  { value: 'Both', label: 'Both (Mixed)', labelHindi: 'दोनों', icon: '🎯' }
                ].map((s) => (
                  <button
                    key={s.value}
                  ...
                  >
                    ...
                    <span>{language === 'english' ? s.label : s.labelHindi}</span>
                  </button>
                ))}
              </div>
            </motion.div>
          ...
          {grade && subject && (
            ...
            >
              ...
              >
                {language === 'english' ? '🚀 Start Learning Journey!' : '🚀 सीखना शुरू करें!'}
      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-purple-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-xl font-bold text-gray-700">
            {language === 'english' ? 'Preparing your questions...' : 'आपके प्रश्न तैयार हो रहे हैं...'}
          </p>
        </div>
      </div>
    );
          ...
          >
            <div className="text-center mb-8">
              ...
              <p className="text-2xl text-gray-600">
                {language === 'english' ? evaluation.encouragement : evaluation.encouragementHindi}
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-8">
              <div className="bg-blue-50 rounded-2xl p-6 text-center">
                ...
                <div className="text-4xl font-bold text-blue-600 mb-1">{evaluation.score}%</div>
              ...
              <div className="bg-green-50 rounded-2xl p-6 text-center">
                ...
                <div className="text-4xl font-bold text-green-600 mb-1">{evaluation.correctAnswers}</div>
                <div className="text-gray-600 font-medium">
              ...
              <div className="bg-purple-50 rounded-2xl p-6 text-center">
                ...
                <div className="text-2xl font-bold text-purple-600 mb-1 capitalize">{evaluation.currentLevel}</div>
                <div className="text-gray-600 font-medium">
            ...
            {evaluation.strengths.length > 0 && (
              <div className="mb-6">
                <h3 className="text-xl font-bold text-green-700 mb-3 flex items-center gap-2">
                  ...
                  {language === 'english' ? 'You\'re Great At:' : 'आप इसमें महान हैं:'}
                </h3>
            ...
            {evaluation.weaknesses.length > 0 && (
              <div className="mb-8">
                <h3 className="text-xl font-bold text-orange-700 mb-3 flex items-center gap-2">
                  <Target />
                  {language === 'english' ? 'Let\'s Practice:' : 'आइए अभ्यास करें:'}
                </h3>
                <div className="flex flex-wrap gap-2">
                  {evaluation.weaknesses.map((weakness, idx) => (
                    <span key={idx} className="bg-orange-100 text-orange-700 px-4 py-2 rounded-full font-medium">
                      📚 {weakness}
                    </span>
                  ))}
                </div>
            ...
            >
              {language === 'english' ? '📅 Get My Personalized Learning Plan' : '📅 मेरी व्यक्तिगत योजना प्राप्त करें'}
            </button>
          </motion.div>
        </div>
      </div>
        ...
        <div className="mb-8">
          <div className="flex justify-between items-center mb-2">
            <span className="text-sm font-bold text-gray-600">
              {language === 'english' ? 'Question' : 'प्रश्न'} {currentQuestion + 1} / {questions.length}
            </span>
          ...
          >
            <div className="mb-6">
              ...
              <h2 className="text-2xl font-bold text-gray-800 mb-4">
                {language === 'english' ? question?.question : question?.questionHindi}
              </h2>
            </div>
            ...
            <div className="space-y-3">
              {question?.options.map((option, idx) => (
                ...
                >
                  ...
                  {language === 'english' ? option : question?.optionsHindi?.[idx]}
                </button>
              ))}
            </div>
            ...
            {answers[question.id] && (
              ...
              >
                {currentQuestion < questions.length - 1
                  ...
                  : language === 'english' ? '✓ Finish Assessment' : '✓ मूल्यांकन समाप्त करें'}
              </motion.button>
            )}
          </motion.div>
        </AnimatePresence>
